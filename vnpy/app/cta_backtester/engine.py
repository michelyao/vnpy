...
from vnpy.trader.tdxdata import tdx_data_client
...
class BacktesterEngine(BaseEngine):
    ...
    def init_tdxdata(self):
        """
        Init RQData client.
        """
        result = tdx_data_client.init()
        if result:
            self.write_log("TdxData数据接口初始化成功")
    ...
    def run_downloading(
        ...
        try:
            ...
            # Otherwise use RQData to query data
                ...
                data = self.main_engine.query_history(req,"FUTU")
                #data = tdx_data_client.query_history(req)
